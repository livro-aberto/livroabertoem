...
\newcommand{\chapterillustration}[2]{
	...
	\else
		\def\la@chapterillustration{#2}
	\fi
}

% \newcommand{\chapterwhat}[1]{
% 	\def\la@chapterwhat{#1}
% }
% \newcommand{\chapterbecause}[1]{
% 	\def\la@chapterbecause{#1}
% }
...
\newcommand{\ChapNumTitle}[1]{%
	...
	\begin{tikzpicture}[remember picture, overlay, external/export=false]
		...
		\begin{pgfonlayer}{bottom}
			\node[opacity=0.3,inner sep=0pt] at (current page.center){\includegraphics[width=\paperwidth,height=\paperheight]{\la@chapterillustration}};
		\end{pgfonlayer}
