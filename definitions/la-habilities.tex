...
\newcommand{\hability}[2][]{%
	...
	\ifhabilities
		...
		\else
			\paragraph{EF#1MA#2}\la@emhability{#1}{#2}
		\fi
	\else
		\la@nothabilities
	\fi
...
\newcommand{\la@nothabilities}{%
	\ClassError{livroaberto}{Outside habilities environment}{%
		You should only use this command in an habilities environment.
	}
}

\newcommand{\la@invalidhability}{%
	\ClassError{livroaberto}{Invalid hability}{%
		Either this hability doesn't exist or you left the field empty.\MessageBreak
		You should enter them by their final three numbers.
	}
}
...
\newcommand{\la@invalidefhability}{%
	\ClassError{livroaberto}{Invalid hability}{%
		Either this hability doesn't exist or you left the field empty.\MessageBreak
		You need to enter the first two numbers of the hability
		on the\MessageBreak
		first argument and the other two at the second argument
	}
}

\newcommand{\la@nohability}{%
	\ClassError{livroaberto}{Missin habilities}{%
		You should enter the habilities using the \protect\hability command.
	}
}
