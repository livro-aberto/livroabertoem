...
\renewcommand*{\notenuminnotes}[1]{{\hspace{-2.5pt}\bannernamefont\color{\currentvolcolor} Nota #1.} \space}
...
\newcommand{\la@teacher@note}[3]{
		\leavevmode\pagenote{
		{
			\color{\currentvolcolor}\bfseries
			{\fontsize{14pt}{0pt}\selectfont #1}\par
			\vspace{-.8\baselineskip}	
			\rule{\widthof{\fontsize{14pt}{0}\selectfont Sugestões e Discussões}+1em}{3pt}\\[.2em]
			{\Large #2}
		}	
		#3
	}
